...
vicious.register(cpuwidget, vicious.widgets.cpu, "<span foreground='orange'>load: </span><span foreground='white'>$2%</span><span foreground='orange'> - </span><span foreground='white'>$3%</span>")
-- }}}
 
-- {{{ CPU temperature
local thermalwidget  = widget({ type = "textbox" })
vicious.register(thermalwidget, vicious.widgets.thermal, "<span foreground='orange'>temp: </span><span foreground='white'>$1°C</span>", 20, "thermal_zone0")
-- }}}
...
vicious.register(batwidget, vicious.widgets.bat, "<span foreground='orange'>bat: </span><span foreground='white'>$1$2%</span>", 60, "BAT0")
-- }}}

-- {{{ Date and time
local datewidget = widget({ type = "textbox" })
vicious.register(datewidget, vicious.widgets.date, "<span foreground='white'>%a, %d.%m.%y - %H:%M</span>", 5)
-- }}}

-- {{{ Volume widget
local volwidget = widget({ type = "textbox" })
vicious.register(volwidget, vicious.widgets.volume, "<span foreground='orange'>vol: </span><span foreground='white'>$1%</span>", 1, 'PCM')
-- }}}

-- {{{ MPD
mympdwidget = widget({ type = "textbox", name = "mympdwidget" })
mympdwidget.width = 230
vicious.register(mympdwidget, vicious.widgets.mpd, "<span color='orange'>music:</span> ${Artist} - ${Title}", 5)
mympdwidget:buttons(awful.util.table.join(
      awful.button({ }, 1, function () awful.util.spawn("mpc pause", false) end),
      awful.button({ }, 2, function () awful.util.spawn("urxvtc -e ncmpcpp", true) end),
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioStop", function() sexec("scrot -e 'mv $f ~/s922183t/screenshots'") end ), --fn - up
   ...
   -- awful.key({"Control", "Mod1"}, "l", function() sexec(commands.lock) end ),
    ...
    awful.key({ modkey, "Control" }, "s", function () sexec("scrot -e 'mv $f ~/s922183t/screenshots'") end ),
